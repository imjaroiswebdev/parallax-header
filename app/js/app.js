document.addEventListener('DOMContentLoaded', function () {
    ...
    var headerH = document.querySelector('.parallax-header').offsetHeight,
        logo = document.querySelector('.parallax-header__logo').style,
        choco = document.querySelector('.parallax-header__choco').style,
        toppers = document.querySelector('.parallax-header__toppers').style;
